...
Upstream: http://lakehouse.uidaho.edu:7010 (AI4RA_MCP_LAKEHOUSE_URL), reachable on campus, so this process
...
BASE = os.environ.get("AI4RA_MCP_LAKEHOUSE_URL", "http://lakehouse.uidaho.edu:7010").rstrip("/")

...
Then read rows 1 to 25 and G57:L57 back and write nothing else. Reply in a few lines: the sheet's name; the rates and where they came from, as D12 says, or that they are not set; the amount requested as the sheet shows it and its share of the ceiling; that the personnel rows hold the template team and the outline's year-1 targets for the administrator to fill against; any check that reads "Over".
